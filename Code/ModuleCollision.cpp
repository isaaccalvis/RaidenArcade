...
ModuleCollision::ModuleCollision(){
	...
	matrix[COLLIDER_OBJECT_NO_COLLISION][COLLIDER_PLAYER2_SHOT] = true;
	...
	matrix[COLLIDER_PLAYER][COLLIDER_OBJECT_COLLISION] = true;
	...
	matrix[COLLIDER_PLAYER_SHOT][COLLIDER_OBJECT_NO_COLLISION] = true;
	...
	matrix[COLLIDER_PLAYER2_SHOT][COLLIDER_OBJECT_NO_COLLISION] = true;
	...
	matrix[COLLIDER_PLAYER2_SHOT][COLLIDER_PLAYER2] = true;
	matrix[COLLIDER_PLAYER2_SHOT][COLLIDER_PLAYER2_SHOT] = false;

	matrix[COLLIDER_ENEMY_SHOT][COLLIDER_OBJECT_NO_COLLISION] = true;
	...
	matrix[COLLIDER_OBJECT_COLLISION][COLLIDER_PLAYER] = true;
	...
	matrix[COLLIDER_PLAYER2][COLLIDER_OBJECT_COLLISION] = true;
...
void ModuleCollision::DebugDraw() {
	...
	for (uint i = 0; i < MAX_COLLIDERS; ++i) {
		...
		case COLLIDER_NONE: // white
			...
			break;
		case COLLIDER_OBJECT_NO_COLLISION: // yellow
